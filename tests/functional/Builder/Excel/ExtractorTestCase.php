...
abstract class ExtractorTestCase extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $extractor = new \Kiboko\Plugin\Spreadsheet\Builder\Excel\Extractor(filePath: new \PhpParser\Node\Scalar\String_(__DIR__ . '/../../files/source-to-extract.xlsx'), sheetName: new \PhpParser\Node\Scalar\String_('Sheet1'), skipLines: new \PhpParser\Node\Scalar\LNumber(0));
