...
final class MultipleFilesLoaderTest extends TestCase
{
    ...
    {
        $loader = new Builder\Excel\MultipleFileLoader(
            filePath: compileExpression(new ExpressionLanguage(), new Expression('format("tests/functional/SKU_%06d.xlsx", index)'), 'index'),
            sheetName: new Node\Scalar\String_('MySheetName'),
            maxLines: new Node\Scalar\LNumber(2)
        );
        ...
        $this->assertFileEquals('vfs://expected-1.xlsx', 'vfs://SKU_000000.xlsx');
        $this->assertFileEquals('vfs://expected-2.xlsx', 'vfs://SKU_000001.xlsx');
    }
}
